...
public class Dialogo extends JDialog implements FocusListener, ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==aceptar) {
			...
			if(nombre.getText().length()==0||apellidos.getText().length()==0||direccion.getText().length()==0||telefono.getText().length()==0||fechae.getText().charAt(9)==' '||fechas.getText().charAt(9)==' ') {
