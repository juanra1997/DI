...
public class ExtraNinnos extends JPanel implements FocusListener{
	...
	public void focusGained(FocusEvent e) {
		...
		if(e.getSource()==area) {
			...
			if(Integer.parseInt(String.valueOf(edad.getValue()))<4&&Integer.parseInt(String.valueOf(edad.getValue()))>=0){
				
				area.setText("Cuna, ");
			}
			if(Integer.parseInt(String.valueOf(edad.getValue()))<11&&Integer.parseInt(String.valueOf(edad.getValue()))>=4){
				
				area.setText("Cama supletoria pequeña, ");
			}
			if(Integer.parseInt(String.valueOf(edad.getValue()))<15&&Integer.parseInt(String.valueOf(edad.getValue()))>=11){
