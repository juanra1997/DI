...
public class CtrlPanelInformes implements ActionListener, KeyListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == panelInformes.informe4){
            String path="src/informes/Informe4.jasper";
        ...
        if(e.getSource() == panelInformes.informe3){
            String path="src/informes/Informe3.jasper";
            
            try {
                Map num = new HashMap();

                try{
                    num.put("cursoelegido", Integer.parseInt(panelInformes.txtOficina.getText()));
                }catch(NumberFormatException ex){
                    num.put("cursoelegido", 11);
                }
