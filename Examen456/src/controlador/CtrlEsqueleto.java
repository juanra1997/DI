...
public class CtrlEsqueleto implements ActionListener/*, FocusListener*/{
     ...
     */
    public CtrlEsqueleto(Esqueleto e, PanelAyuda pa, PanelCursos pp,/* PanelVehiculos pv,*/ PanelInformes pi, Connection c){
    ...
    public void ponerProductos(){
        quitarPaneles();
        esqueleto.getContentPane().add(cursos);
        ultimar();
        cursos.requestFocus();
    ...
    public void Ayuda(){
        try{
            ...
            hb.enableHelpKey(cursos, "cursos", helpset);
            //hb.enableHelpKey(vehiculos, "vehiculos", helpset);
            hb.enableHelpKey(cursos.buscar, "pbuscar", helpset);
            hb.enableHelpKey(cursos.limpiar, "plimpiar", helpset);
            hb.enableHelpKey(cursos.borrar, "pborrar", helpset);
            hb.enableHelpKey(cursos.actualizar, "pactualizar", helpset);
            hb.enableHelpKey(cursos.guardar, "pguardar", helpset);
